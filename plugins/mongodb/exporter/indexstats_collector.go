...
func newIndexStatsCollector(ctx context.Context, client *mongo.Client, discovery, overrideDescendingIndex bool, topology labelsGetter, collections []string) *indexstatsCollector {
