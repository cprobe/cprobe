...
var (
	readCalls    = metrics.NewCounter(`cprobe_fs_read_calls_total`)
	readBytes    = metrics.NewCounter(`cprobe_fs_read_bytes_total`)
	readersCount = metrics.NewCounter(`cprobe_fs_readers`)
)
