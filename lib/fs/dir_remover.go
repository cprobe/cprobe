...
import (
	...
	"github.com/cprobe/cprobe/lib/syncwg"
)
...
var (
	nfsDirRemoveFailedAttempts = metrics.NewCounter(`cprobe_nfs_dir_remove_failed_attempts_total`)
	_                          = metrics.NewGauge(`cprobe_nfs_pending_dirs_to_remove`, func() float64 {
